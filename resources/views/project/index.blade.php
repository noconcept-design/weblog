...
@section('content')
	<h1 clas="mt-10 px-10 text-5xl font-normal leading-normal test-center">Projekte</h1>
	<!-- PROJEKT LISTE -->
    ...
    <div class="w-full lg:w-1/2 border-b border-r py-12">
    	<div class="mx-auto w-3/4 flex flex-col justify-between">
    		<a href="/projects/{{$project->slug}}">
    			...
    			<h2 class="mt-5 text-base font-bold">{{$project->title}}</h2>

    			<span class="text-base">{{$project->headline}}</span>
